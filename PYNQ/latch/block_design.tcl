...
proc create_root_design { parentCell } {
  ...
  # Create instance: TRNG_IP_0, and set properties
  set TRNG_IP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:TRNG_IP:1.0 TRNG_IP_0 ]
  ...
  connect_bd_intf_net -intf_net TRNG_IP_0_AXIS_RNG [get_bd_intf_pins TRNG_IP_0/AXIS_RNG] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs TRNG_IP_0/AXI_CTRL/reg0] -force
